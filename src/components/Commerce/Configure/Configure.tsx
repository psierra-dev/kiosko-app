...
const Configure = () => {
  ...
  const mdCobro = async () => {
    ...
    window.location.replace(
      "https://auth.mercadopago.com/authorization?client_id=1379032387256720&response_type=code&platform_id=mp&state=AUTORIZACION&redirect_uri=http://localhost:3001/mercadopago/redirect"
    );
  ...
  return (
    <ConfigureStyle>
      ...
      <div className="card-sec" onClick={mdCobro}>
        <p>
